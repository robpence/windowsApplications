#pragma checksum "c:\users\robert\source\repos\App1\App1\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "223EFEE0D2C29BD2A5297C3FC8F50753"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace App1
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj4_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::App1.Model.MenuItem dataRoot;
            ...
            {
                 global::App1.Model.MenuItem data = args.NewValue as global::App1.Model.MenuItem;
                 if (args.NewValue != null && data == null)
                 {
                    throw new global::System.ArgumentException("Incorrect type passed into template. Based on the x:DataType global::App1.Model.MenuItem was expected.");
                 }
            ...
            public int ProcessBindings(global::Windows.UI.Xaml.Controls.ContainerContentChangingEventArgs args)
            {
                ...
                switch(args.Phase)
                {
                    case 0:
                        nextPhase = -1;
                        this.SetDataRoot(args.Item as global::App1.Model.MenuItem);
                ...
                this.Update_((global::App1.Model.MenuItem) args.Item, 1 << (int)args.Phase);
                return nextPhase;
            }
            ...
            public void SetDataRoot(global::App1.Model.MenuItem newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }

            // Update methods for each path node used in binding steps.
            private void Update_(global::App1.Model.MenuItem obj, int phase)
            {
                if (obj != null)
                {
            ...
            private void Update_Category(global::App1.Model.SoundCategory obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        private class MainPage_obj10_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::App1.Model.Sound dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            private bool removedDataContextHandler = false;
            ...
            public void DataContextChangedHandler(global::Windows.UI.Xaml.FrameworkElement sender, global::Windows.UI.Xaml.DataContextChangedEventArgs args)
            {
                 global::App1.Model.Sound data = args.NewValue as global::App1.Model.Sound;
                 if (args.NewValue != null && data == null)
                 {
                    throw new global::System.ArgumentException("Incorrect type passed into template. Based on the x:DataType global::App1.Model.Sound was expected.");
                 }
                 this.SetDataRoot(data);
                 this.Update();
            }
            ...
            public int ProcessBindings(global::Windows.UI.Xaml.Controls.ContainerContentChangingEventArgs args)
            {
                ...
                switch(args.Phase)
                {
                    case 0:
                        nextPhase = -1;
                        this.SetDataRoot(args.Item as global::App1.Model.Sound);
                        if (!removedDataContextHandler)
                        {
                            removedDataContextHandler = true;
                ...
                this.Update_((global::App1.Model.Sound) args.Item, 1 << (int)args.Phase);
                return nextPhase;
            }
            ...
            public void SetDataRoot(global::App1.Model.Sound newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }

            // Update methods for each path node used in binding steps.
            private void Update_(global::App1.Model.Sound obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            IMainPage_Bindings
        {
            ...
            private void Update_MenuItems(global::System.Collections.Generic.List<global::App1.Model.MenuItem> obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_Sounds(global::System.Collections.ObjectModel.ObservableCollection<global::App1.Model.Sound> obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            case 4:
                {
                    ...
                    returnValue = bindings;
                    bindings.SetDataRoot((global::App1.Model.MenuItem) element4.DataContext);
            ...
            case 10:
                {
                    ...
                    returnValue = bindings;
                    bindings.SetDataRoot((global::App1.Model.Sound) element10.DataContext);
